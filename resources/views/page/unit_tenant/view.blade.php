    ...
    <form class="form-horizontal" role="form" id="form_add" method="post" action="{{url('/unit_tenant/'. $id)}}">
        ...
        <div class="tab-content">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" id="nama_perusahaan_unit_tenant" name="nama_perusahaan_unit_tenant" class="col-xs-10 col-sm-5"
                        value='{{$data->nama_perusahaan_unit_tenant}}' disabled />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" id="kode_unit_tenant" name="kode_unit_tenant" class="col-xs-10 col-sm-5" value='{{$data->kode_unit_tenant}}'
                        disabled />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" id="nama_unit_tenant" name="nama_unit_tenant" class="col-xs-10 col-sm-5" value='{{$data->nama_unit_tenant}}'
                        disabled />
                </div>
            </div>
                ...
                <div class="col-sm-3">
                    <div class="input-group input-group-sm">
                        <input type="text" id="id-date-picker-1" name="tgl_mulai_kontrak" class="form-control date-picker col-xs-10 col-sm-5"
                            data-date-format="dd-mm-yyyy" value='{{$data->tgl_mulai_kontrak}}' disabled />
                ...
                <div class="col-sm-3">
                    <div class="input-group input-group-sm">
                        <input type="text" id="id-date-picker-2" name="tgl_habis_kontrak" class="form-control date-picker col-xs-10 col-sm-5"
                            data-date-format="dd-mm-yyyy" value='{{$data->tgl_habis_kontrak}}' disabled />
                        <span class="input-group-addon">
                            <i class="ace-icon fa fa-calendar"></i>
                        </span>
                    </div>
