...
<div class="col-xs-12">
    <!-- PAGE CONTENT BEGINS -->
    <form class="form-horizontal" role="form" id="form_add" method="post" action="{{url('/unit_renter')}}">
        @csrf
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <select class="chosen-select form-control" name="id_unit_apart" id="form-field-select-1"
                                data-placeholder="Choose Unit..." required />
                            <option value=""> </option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <select class="chosen-select form-control" name="id_country" id="form-field-select-1"
                                data-placeholder="Choose Nationality..." required />
                            <option value=""> </option>
