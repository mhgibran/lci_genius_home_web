            ...
            <div class="tab-content">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <select class="chosen-select form-control" name="id_country" id="form-field-select-1"
                                data-placeholder="Choose Nationality..." disabled>
                                <option value=""> </option>
                ...
                <div id="tab3" class="tab-pane fade">
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <div class="input-group">
                                <input class="form-control date" id="datetimepicker1" name="start_rent" placeholder="Start Date"
                                    type="text" data-date-format="dd-mm-yyyy" value='{{$data->start_rent}}' disabled />
                                <span class="input-group-addon">
                                    <i class="fa fa-calendar bigger-110"></i>
                                </span>
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <div class="input-group">
                                <input class="form-control date" id="datetimepicker2" name="end_rent" placeholder="End Date"
                                    type="text" data-date-format="dd-mm-yyyy" value='{{$data->end_rent}}' disabled />
                                <span class="input-group-addon">
                                    <i class="fa fa-calendar bigger-110"></i>
                                </span>
                            </div>
