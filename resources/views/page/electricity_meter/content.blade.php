<div class="col-xs-12">
    <div class="width=auto">
        <h1 class="header smaller lighter blue">
            <center><b>ELECTRICITY METER INFORMATION</b></center>
        </h1>
        ...
        <div class="clearfix">
            <div>
                ...
                <a href='/ElectricityMeterExportExcel'>
                    <button id="export_button" type="button" class="btn btn-success">Export to Excel</button>
                </a>
                <form id="upload_form" action="/ElectricityMeterImportExcel" method="post" enctype="multipart/form-data"
            ...
            <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="center">{{$item->listrik_awal}}</td>
                        <td class="center">{{$item->listrik_akhir}}</td>
                        <td class="center">{{$item->pemakaian_listrik}}</td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
