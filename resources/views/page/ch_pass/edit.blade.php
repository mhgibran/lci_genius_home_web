<form id="form_add" method="post" action="{{url('/user/update/'. $id)}}">
        ...
        <div class="row">
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-5">
                    <input type="text" id="login" name="login" required="required" class="form-control col-md-7 col-xs-12" value="{{ $data->login }}" disabled="disabled">
                </div>
            </div>
        </div>
        <hr />
        <div class="row">
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="password" id="password" name="password" required="required" class="form-control col-md-7 col-xs-12" value="{{ $data->password }}">
                </div>
            </div>
        </div>
        <hr />
