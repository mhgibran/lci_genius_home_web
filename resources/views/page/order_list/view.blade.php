<form id="form_add" method="post" action="{{url('/order_list')}}">
        ...
        <div class="row">
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <textarea id="description" name="description" class="form-control col-md-7 col-xs-12 noresize" rows="3" readonly="" value="{{$data->description}}"></textarea>
                </div>
            </div>
        </div>
